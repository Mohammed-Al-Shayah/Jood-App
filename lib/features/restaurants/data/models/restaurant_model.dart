...
class RestaurantModel extends RestaurantEntity {
  ...
  factory RestaurantModel.fromEntity(RestaurantEntity restaurant) {
    if (restaurant is RestaurantModel) return restaurant;
    return RestaurantModel(
      id: restaurant.id,
      ...
      openTo: restaurant.openTo,
      highlights: restaurant.highlights,
      inclusions: restaurant.inclusions,
      exclusions: restaurant.exclusions,
      cancellationPolicy: restaurant.cancellationPolicy,
      knowBeforeYouGo: restaurant.knowBeforeYouGo,
      ...
      priceFromValue: restaurant.priceFromValue,
      ...
      cityIdEn: restaurant.cityIdEn,
      cityIdAr: restaurant.cityIdAr,
      areaEn: restaurant.areaEn,
      areaAr: restaurant.areaAr,
      aboutEn: restaurant.aboutEn,
      aboutAr: restaurant.aboutAr,
      addressEn: restaurant.addressEn,
      addressAr: restaurant.addressAr,
      highlightsEn: restaurant.highlightsEn,
      highlightsAr: restaurant.highlightsAr,
      inclusionsEn: restaurant.inclusionsEn,
      inclusionsAr: restaurant.inclusionsAr,
      exclusionsEn: restaurant.exclusionsEn,
      exclusionsAr: restaurant.exclusionsAr,
      cancellationPolicyEn: restaurant.cancellationPolicyEn,
      cancellationPolicyAr: restaurant.cancellationPolicyAr,
      knowBeforeYouGoEn: restaurant.knowBeforeYouGoEn,
      knowBeforeYouGoAr: restaurant.knowBeforeYouGoAr,
      buffetDescription: restaurant.buffetDescription,
      buffetHighlights: restaurant.buffetHighlights,
      buffetIncluded: restaurant.buffetIncluded,
      buffetExcluded: restaurant.buffetExcluded,
      buffetTermsAndConditions: restaurant.buffetTermsAndConditions,
      buffetCancellationPolicy: restaurant.buffetCancellationPolicy,
      buffetAvailableOptions: restaurant.buffetAvailableOptions,
      buffetLocation: restaurant.buffetLocation,
      buffetDescriptionEn: restaurant.buffetDescriptionEn,
      buffetDescriptionAr: restaurant.buffetDescriptionAr,
      buffetHighlightsEn: restaurant.buffetHighlightsEn,
      buffetHighlightsAr: restaurant.buffetHighlightsAr,
      buffetIncludedEn: restaurant.buffetIncludedEn,
      buffetIncludedAr: restaurant.buffetIncludedAr,
      buffetExcludedEn: restaurant.buffetExcludedEn,
      buffetExcludedAr: restaurant.buffetExcludedAr,
      buffetTermsAndConditionsEn: restaurant.buffetTermsAndConditionsEn,
      buffetTermsAndConditionsAr: restaurant.buffetTermsAndConditionsAr,
      buffetCancellationPolicyEn: restaurant.buffetCancellationPolicyEn,
      buffetCancellationPolicyAr: restaurant.buffetCancellationPolicyAr,
      buffetAvailableOptionsEn: restaurant.buffetAvailableOptionsEn,
      buffetAvailableOptionsAr: restaurant.buffetAvailableOptionsAr,
      buffetLocationEn: restaurant.buffetLocationEn,
      buffetLocationAr: restaurant.buffetLocationAr,
      setMenuDescription: restaurant.setMenuDescription,
      setMenuHighlights: restaurant.setMenuHighlights,
      setMenuIncluded: restaurant.setMenuIncluded,
      setMenuTermsAndConditions: restaurant.setMenuTermsAndConditions,
      setMenuCancellationPolicy: restaurant.setMenuCancellationPolicy,
      setMenuAvailableOptions: restaurant.setMenuAvailableOptions,
      setMenuLocation: restaurant.setMenuLocation,
      setMenuDescriptionEn: restaurant.setMenuDescriptionEn,
      setMenuDescriptionAr: restaurant.setMenuDescriptionAr,
      setMenuHighlightsEn: restaurant.setMenuHighlightsEn,
      setMenuHighlightsAr: restaurant.setMenuHighlightsAr,
      setMenuIncludedEn: restaurant.setMenuIncludedEn,
      setMenuIncludedAr: restaurant.setMenuIncludedAr,
      setMenuTermsAndConditionsEn: restaurant.setMenuTermsAndConditionsEn,
      setMenuTermsAndConditionsAr: restaurant.setMenuTermsAndConditionsAr,
      setMenuCancellationPolicyEn: restaurant.setMenuCancellationPolicyEn,
      setMenuCancellationPolicyAr: restaurant.setMenuCancellationPolicyAr,
      setMenuAvailableOptionsEn: restaurant.setMenuAvailableOptionsEn,
      setMenuAvailableOptionsAr: restaurant.setMenuAvailableOptionsAr,
      setMenuLocationEn: restaurant.setMenuLocationEn,
      setMenuLocationAr: restaurant.setMenuLocationAr,
      comboDescription: restaurant.comboDescription,
      comboHighlights: restaurant.comboHighlights,
      comboIncluded: restaurant.comboIncluded,
      comboTermsAndConditions: restaurant.comboTermsAndConditions,
      comboCancellationPolicy: restaurant.comboCancellationPolicy,
      comboAvailableOptions: restaurant.comboAvailableOptions,
      comboLocation: restaurant.comboLocation,
      comboDescriptionEn: restaurant.comboDescriptionEn,
      comboDescriptionAr: restaurant.comboDescriptionAr,
      comboHighlightsEn: restaurant.comboHighlightsEn,
      comboHighlightsAr: restaurant.comboHighlightsAr,
      comboIncludedEn: restaurant.comboIncludedEn,
      comboIncludedAr: restaurant.comboIncludedAr,
      comboTermsAndConditionsEn: restaurant.comboTermsAndConditionsEn,
      comboTermsAndConditionsAr: restaurant.comboTermsAndConditionsAr,
      comboCancellationPolicyEn: restaurant.comboCancellationPolicyEn,
      comboCancellationPolicyAr: restaurant.comboCancellationPolicyAr,
      comboAvailableOptionsEn: restaurant.comboAvailableOptionsEn,
      comboAvailableOptionsAr: restaurant.comboAvailableOptionsAr,
      comboLocationEn: restaurant.comboLocationEn,
      comboLocationAr: restaurant.comboLocationAr,
    );
  }
