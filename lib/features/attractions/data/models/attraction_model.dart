...
class AttractionModel extends AttractionEntity {
  ...
  factory AttractionModel.fromEntity(AttractionEntity attraction) {
    if (attraction is AttractionModel) return attraction;
    return AttractionModel(
      id: attraction.id,
      ...
      geoLat: attraction.geoLat,
      geoLng: attraction.geoLng,
      highlights: attraction.highlights,
      inclusions: attraction.inclusions,
      catalogDescription: attraction.catalogDescription,
      catalogHighlights: attraction.catalogHighlights,
      catalogIncluded: attraction.catalogIncluded,
      packageOverview: attraction.packageOverview,
      ...
      slotsLeft: attraction.slotsLeft,
      nameEn: attraction.nameEn,
      nameAr: attraction.nameAr,
      cityIdEn: attraction.cityIdEn,
      cityIdAr: attraction.cityIdAr,
      areaEn: attraction.areaEn,
      areaAr: attraction.areaAr,
      aboutEn: attraction.aboutEn,
      aboutAr: attraction.aboutAr,
      addressEn: attraction.addressEn,
      addressAr: attraction.addressAr,
      highlightsEn: attraction.highlightsEn,
      highlightsAr: attraction.highlightsAr,
      inclusionsEn: attraction.inclusionsEn,
      inclusionsAr: attraction.inclusionsAr,
      catalogDescriptionEn: attraction.catalogDescriptionEn,
      catalogDescriptionAr: attraction.catalogDescriptionAr,
      catalogHighlightsEn: attraction.catalogHighlightsEn,
      catalogHighlightsAr: attraction.catalogHighlightsAr,
      catalogIncludedEn: attraction.catalogIncludedEn,
      catalogIncludedAr: attraction.catalogIncludedAr,
      packageOverviewEn: attraction.packageOverviewEn,
      packageOverviewAr: attraction.packageOverviewAr,
      bookingNotesEn: attraction.bookingNotesEn,
      bookingNotesAr: attraction.bookingNotesAr,
      catalogExcluded: attraction.catalogExcluded,
      catalogTermsAndConditions: attraction.catalogTermsAndConditions,
      catalogCancellationPolicy: attraction.catalogCancellationPolicy,
      catalogAvailableOptions: attraction.catalogAvailableOptions,
      catalogLocation: attraction.catalogLocation,
      catalogExcludedEn: attraction.catalogExcludedEn,
      catalogExcludedAr: attraction.catalogExcludedAr,
      catalogTermsAndConditionsEn: attraction.catalogTermsAndConditionsEn,
      catalogTermsAndConditionsAr: attraction.catalogTermsAndConditionsAr,
      catalogCancellationPolicyEn: attraction.catalogCancellationPolicyEn,
      catalogCancellationPolicyAr: attraction.catalogCancellationPolicyAr,
      catalogAvailableOptionsEn: attraction.catalogAvailableOptionsEn,
      catalogAvailableOptionsAr: attraction.catalogAvailableOptionsAr,
      catalogLocationEn: attraction.catalogLocationEn,
      catalogLocationAr: attraction.catalogLocationAr,
    );
  }
